...
On `start`, `demo-it` also writes tmux global environment values (`DEMO_IT_PATH`, `DEMO_IT_SOCKET`) so prefix bindings can execute with the same binary/socket context.
